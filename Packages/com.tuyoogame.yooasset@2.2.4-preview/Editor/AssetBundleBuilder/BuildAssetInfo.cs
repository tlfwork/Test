...
namespace YooAsset.Editor
{
    public class BuildAssetInfo
    {
        ...
        private readonly HashSet<string> _referenceBundleNames = new HashSet<string>();//这个资源被那些包所依赖
        ...
        /// 资源包完整名称
        /// </summary>
        public string BundleName { private set; get; }//firstpackage_assets_res_model_mat.bundle
        ...
        public void AddReferenceBundleName(string bundleName)
        {
            ...
            if (!_referenceBundleNames.Contains(bundleName))
