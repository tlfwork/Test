...
namespace YooAsset.Editor
{
    ...
    public abstract class BuildParameters
    {
        ...
        public virtual void CheckBuildParameters()
        {
            ...
            {
                string packageRootDirectory = GetPackageRootDirectory();//D:/unitylearn/Test/Bundles/StandaloneWindows64/FirstPackage
            ...
            if (BuildMode != EBuildMode.SimulateBuild)
            {
                string packageOutputDirectory = GetPackageOutputDirectory();//D:/unitylearn/Test/Bundles/StandaloneWindows64/FirstPackage/v1
            ...
            // 如果输出目录不存在
            string pipelineOutputDirectory = GetPipelineOutputDirectory();//D:/unitylearn/Test/Bundles/StandaloneWindows64/FirstPackage/OutputCache
