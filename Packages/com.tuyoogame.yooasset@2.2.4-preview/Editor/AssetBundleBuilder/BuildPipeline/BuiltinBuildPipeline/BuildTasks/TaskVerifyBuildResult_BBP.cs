...
using UnityEditor;
using UnityEngine;
using static YooAsset.Editor.TaskBuilding_BBP;
...
namespace YooAsset.Editor
{
    public class TaskVerifyBuildResult_BBP : IBuildTask
    {
        ...
        {
            BuiltinBuildParameters buildParameters = context.GetContextObject<BuildParametersContext>().Parameters as BuiltinBuildParameters;
            ...
            {
                BuildResultContext buildResultContext = context.GetContextObject<BuildResultContext>();
