...
namespace YooAsset.Editor
{
    public class AssetBundleBuilder
    {
        ...
        public BuildResult Run(BuildParameters buildParameters, List<IBuildTask> buildPipeline, bool enableLog)
        {
            ...
            // 构建参数
            BuildParametersContext buildParametersContext = new BuildParametersContext(buildParameters);
            ...
            BuildResult buildResult = BuildRunner.Run(buildPipeline, _buildContext);
