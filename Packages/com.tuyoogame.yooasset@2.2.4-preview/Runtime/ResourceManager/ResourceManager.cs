...
namespace YooAsset
{
    internal class ResourceManager
    {
        ...
        public void TryUnloadUnusedAsset(AssetInfo assetInfo)
        {
            ...
            LoadBundleFileOperation mainLoader = TryGetFileLoader(mainBundleName);
        ...
        public SceneHandle LoadSceneAsync(AssetInfo assetInfo, LoadSceneParameters loadSceneParams, bool suspendLoad, uint priority)
        {
            ...
            string providerGUID = $"{assetInfo.GUID}-{++_sceneCreateCount}"; //[Assets/Res/Scene/scene_one.unity][null]-1
            ...
            SceneHandle handle = provider.CreateHandle<SceneHandle>();
        ...
        public AssetHandle LoadAssetAsync(AssetInfo assetInfo, uint priority)
        {
            ...
            string providerGUID = nameof(LoadAssetAsync) + assetInfo.GUID; //LoadAssetAsync[Assets/Res/Model/Mat/100.mat][Material]
        ...
        internal LoadDependBundleFileOperation CreateDependFileLoaders(AssetInfo assetInfo)
        {
            ...
            LoadDependBundleFileOperation operation = new LoadDependBundleFileOperation(depends);
