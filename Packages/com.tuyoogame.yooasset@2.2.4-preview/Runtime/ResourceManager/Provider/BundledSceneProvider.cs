...
namespace YooAsset
{
    internal sealed class BundledSceneProvider : ProviderOperation
    {
        ...
        private bool _suspendLoadMode;  //false
        ...
        internal override void InternalOnUpdate()
        {
            ...
            {
                if (!LoadDependBundleFileOp.IsDone) 

                    return;

                if (!LoadBundleFileOp.IsDone)
            ...
            if (_steps == ESteps.Loading)
            {
                ...
                else
                {
                    ...
                    _asyncOperation = SceneManager.LoadSceneAsync(MainAssetInfo.AssetPath, LoadSceneParams); //Assets/Res/Scene/scene_one.unity
