...
namespace YooAsset
{
    internal abstract class ProviderOperation : AsyncOperationBase
    {
        ...
        /// 资源提供者唯一标识符
        /// </summary>
        public string ProviderGUID { private set; get; }    //[Assets/Res/Scene/scene_one.unity][null]-1
        ...
        /// 加载的场景名称
        /// </summary>
        public string SceneName { protected set; get; } //scene_one
        ...
        protected void InvokeCompletion(string error, EOperationStatus status)
        {
            ...
            foreach (HandleBase hande in tempers)
            {
                if (hande.IsValid)
                {
