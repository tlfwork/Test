    ...
    internal sealed class LoadBuildinCatalogFileOperation : AsyncOperationBase
    {
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.LoadCatalog)
            {
                ...
                DefaultBuildinFileCatalog catalog = Resources.Load<DefaultBuildinFileCatalog>(catalogFilePath);
                ...
                foreach (FileWrapper wrapper in catalog.Wrappers)
                {
                    DefaultBuildinFileSystem.FileWrapper fileWrapper = new DefaultBuildinFileSystem.FileWrapper(wrapper.FileName);
