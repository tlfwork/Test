...
using System.IO;
using UnityEngine;
using static YooAsset.DefaultBuildinFileCatalog;
...
namespace YooAsset
{
    public class DefaultBuildinFileSystemBuild : UnityEditor.Build.IPreprocessBuildWithReport
    {
        ...
        /// 生成包裹的内置资源目录文件
        /// </summary>
        //pacakgeDirectory   D:/unitylearn/Test/Assets/StreamingAssets/yoo/FirstPackage
        public static void CreateBuildinCatalogFile(string packageName, string pacakgeDirectory)
        {
            ...
            string packageVersion;
            {
                ...
                // D:/unitylearn/Test/Assets/StreamingAssets/yoo/FirstPackage/PackageManifest_FirstPackage.version
            ...
            PackageManifest packageManifest;
            {
                ...
                //D:/unitylearn/Test/Assets/StreamingAssets/yoo/FirstPackage/PackageManifest_FirstPackage_v1.bytes
                if (File.Exists(manifestFilePath) == false)
                {
                    throw new System.Exception($"Can not found package manifest file : {manifestFilePath}");
                }

                byte[] binaryData = FileUtility.ReadAllBytes(manifestFilePath);
            ...
            Dictionary<string, string> fileMapping = new Dictionary<string, string>();
            {
                ...
                {
                    //key   41edab5f73cd63214e760fb5f18ec25c.bundle
                    //val   41edab5f73cd63214e760fb5f18ec25c
                    fileMapping.Add(packageBundle.FileName, packageBundle.BundleGUID);
                }
            }

            // 创建内置清单实例
            DefaultBuildinFileCatalog buildinFileCatalog = ScriptableObject.CreateInstance<DefaultBuildinFileCatalog>();
            ...
            foreach (var fileInfo in fileInfos)
            {
                ...
                {
                    var wrapper = new FileWrapper(bundleGUID, fileName);
