...
namespace YooAsset
{
    ...
    internal class DefaultBuildinFileSystem : IFileSystem
    {
        ...
        //KEY   41edab5f73cd63214e760fb5f18ec25c
        //VAL   41edab5f73cd63214e760fb5f18ec25c.bundle
        ...
        }    //  D:/unitylearn/Test/Assets/StreamingAssets/yoo/FirstPackage
        ...
        public virtual void OnCreate(string packageName, string rootDirectory)
        {
            ...
            if (string.IsNullOrEmpty(rootDirectory))
                ...
                rootDirectory = GetDefaultRoot();     //  D:/unitylearn/Test/Assets/StreamingAssets/yoo

            _packageRoot = PathUtility.Combine(rootDirectory, packageName);    //  D:/unitylearn/Test/Assets/StreamingAssets/yoo/FirstPackage

            // 创建解压文件系统
            UnpackRemoteServices remoteServices = new UnpackRemoteServices(_packageRoot);
