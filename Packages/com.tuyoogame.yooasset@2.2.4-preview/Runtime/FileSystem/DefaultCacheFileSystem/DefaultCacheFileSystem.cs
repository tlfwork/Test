...
namespace YooAsset
{
    ...
    internal class DefaultCacheFileSystem : IFileSystem
    {
        ...
        {
            public string InfoFilePath { private set; get; } //D:\\unitylearn\\Test\\yoo\\FirstPackage\\CacheFiles\\41\\41edab5f73cd63214e760fb5f18ec25c/__info
            public string DataFilePath { private set; get; } //D:\\unitylearn\\Test\\yoo\\FirstPackage\\CacheFiles\\41\\41edab5f73cd63214e760fb5f18ec25c/__data
            public string DataFileCRC { private set; get; }  //从_info文件里读取出来的CRC
            public long DataFileSize { private set; get; }   //从_info文件里读取出来的大小
        ...
        //GUID 在初始化验证文件的时候 和 当一个下载器完成下载的时候
        ...
        protected string _packageRoot;      // D:/unitylearn/Test/yoo/FirstPackage

        protected string _saveFileRoot;     // D:/unitylearn/Test/yoo/FirstPackage/CacheFiles

        protected string _tempFileRoot;     // D:/unitylearn/Test/yoo/FirstPackage/CacheTempFiles

        protected string _manifestFileRoot; // D:/unitylearn/Test/yoo/FirstPackage/ManifestFiles
        ...
        {
            DCFSInitializeOperation operation = new DCFSInitializeOperation(this);
        ...
        {
            DCFSRequestPackageVersionOperation operation = new DCFSRequestPackageVersionOperation(this, appendTimeTicks, timeout);
        ...
        public virtual FSDownloadFileOperation DownloadFileAsync(PackageBundle bundle, DownloadParam param)
        {
            ...
            // 创建新的下载器
            {
                ...
                {
                    DCFSDownloadResumeFileOperation newDownloader = new DCFSDownloadResumeFileOperation(this, bundle, param);
                ...
                {
                    DCFSDownloadNormalFileOperation newDownloader = new DCFSDownloadNormalFileOperation(this, bundle, param);
        ...
        public virtual FSLoadBundleOperation LoadBundleFile(PackageBundle bundle)
        {
            ...
            {
                DCFSLoadAssetBundleOperation operation = new DCFSLoadAssetBundleOperation(this, bundle);
        ...
        public virtual void OnCreate(string packageName, string rootDirectory)
        {
            ...
            _packageRoot = PathUtility.Combine(rootDirectory, packageName);                                             // D:/unitylearn/Test/yoo/FirstPackage

            _saveFileRoot = PathUtility.Combine(_packageRoot, DefaultCacheFileSystemDefine.SaveFilesFolderName);        // D:/unitylearn/Test/yoo/FirstPackage/CacheFiles

            _tempFileRoot = PathUtility.Combine(_packageRoot, DefaultCacheFileSystemDefine.TempFilesFolderName);        // D:/unitylearn/Test/yoo/FirstPackage/CacheTempFiles

            _manifestFileRoot = PathUtility.Combine(_packageRoot, DefaultCacheFileSystemDefine.ManifestFilesFolderName);// D:/unitylearn/Test/yoo/FirstPackage/ManifestFiles
        }
        ...
        public virtual void OnUpdate()
        {
            ...
            {
                DefaultDownloadFileOperation downloader = valuePair.Value;
        ...
        /// 写入缓存文件
        /// </summary>
        public bool WriteCacheFile(PackageBundle bundle, string copyPath)//D:/unitylearn/Test/yoo/FirstPackage/CacheTempFiles/f2ddd9857b438bb43e89378791580897
        {
            ...
            string infoFilePath = GetInfoFilePath(bundle);//D:/unitylearn/Test/yoo/FirstPackage/CacheFiles/f2/f2ddd9857b438bb43e89378791580897/__info

            string dataFilePath = GetDataFilePath(bundle);//D:/unitylearn/Test/yoo/FirstPackage/CacheFiles/f2/f2ddd9857b438bb43e89378791580897/__data
