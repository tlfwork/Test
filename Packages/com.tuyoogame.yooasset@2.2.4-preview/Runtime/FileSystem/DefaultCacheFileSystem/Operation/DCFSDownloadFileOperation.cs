...
namespace YooAsset
{
    internal sealed class DCFSDownloadNormalFileOperation : DefaultDownloadFileOperation
    {
        ...
        private string _tempFilePath;   //D:/unitylearn/Test/yoo/FirstPackage/CacheTempFiles/f2ddd9857b438bb43e89378791580897
        ...
        {
            //D:/unitylearn/Test/yoo/FirstPackage/CacheTempFiles/f2ddd9857b438bb43e89378791580897
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.CreateRequest)
            {
                ...
                // 获取请求地址
                _requestURL = GetRequestURL();//http://panda/Res/v1/f2ddd9857b438bb43e89378791580897.bundle
            ...
            {
                TempFileElement element = new TempFileElement(_tempFilePath, Bundle.FileCRC, Bundle.FileSize);
