...
namespace YooAsset
{
    internal class CacheFileElement
    {
        ...
        public string BundleGUID { private set; get; }      //41edab5f73cd63214e760fb5f18ec25c
        public string FileRootPath { private set; get; }    //D:\\unitylearn\\Test\\yoo\\FirstPackage\\CacheFiles\\41\\41edab5f73cd63214e760fb5f18ec25c
    ...
    internal class VerifyCacheFilesOperation : AsyncOperationBase
    {
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.UpdateVerify)
            {
                ...
                for (int i = _waitingList.Count - 1; i >= 0; i--)
                {
                    ...
                    CacheFileElement element = _waitingList[i];
        ...
        private void VerifyCallback(object obj)
        {
            ...
            if (element.Result == EFileVerifyResult.Succeed)
            {
                ...
                DefaultCacheFileSystem.FileWrapper fileWrapper = new DefaultCacheFileSystem.FileWrapper(element.InfoFilePath, element.DataFilePath, element.DataFileCRC, element.DataFileSize);
