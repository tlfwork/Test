...
namespace YooAsset
{
    internal class DownloadPackageHashOperation : AsyncOperationBase
    {
        ...
        internal override void InternalOnUpdate()
        {
            ...
            {
                string filePath = _fileSystem.GetCachePackageHashFilePath(_packageVersion); //D:/unitylearn/Test/yoo/FirstPackage/ManifestFiles/PackageManifest_FirstPackage_v1.hash
            ...
            if (_steps == ESteps.DownloadFile)
            {
                ...
                {
                    string savePath = _fileSystem.GetCachePackageHashFilePath(_packageVersion);//D:/unitylearn/Test/yoo/FirstPackage/ManifestFiles/PackageManifest_FirstPackage_v1.hash

                    string fileName = YooAssetSettingsData.GetPackageHashFileName(_fileSystem.PackageName, _packageVersion); //PackageManifest_FirstPackage_v1.hash

                    string webURL = GetWebRequestURL(fileName); //http://panda/Res/v1/PackageManifest_FirstPackage_v1.hash
