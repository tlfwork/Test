        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.LoadAssetBundle)
            {
                ...
                else
                {
                    ...
                    {
                        string filePath = _fileSystem.GetCacheFileLoadPath(_bundle);//D:/unitylearn/Test/yoo/FirstPackage/CacheFiles/72/7242319cc7ff60a7e206ab82f27376fb/__data
            ...
            if (_steps == ESteps.CheckResult)
            {
                ...
                if (verifyResult == EFileVerifyResult.Succeed)
                {
                    ...
                    byte[] fileData = FileUtility.ReadAllBytes(filePath);//D:/unitylearn/Test/yoo/FirstPackage/CacheFiles/72/7242319cc7ff60a7e206ab82f27376fb/__data
