...
namespace YooAsset
{
    ...
    internal class PackageManifest
    {
        ...
        //firstpackage_assets_res_model_mat.bundle
        /// <summary>
        ...
        //41edab5f73cd63214e760fb5f18ec25c.bundle  cache --> AB包文件流 --> MD5工具生成的文件名
        /// <summary>
        ...
        //这个包开启IncludeAssetGUID才行
        //406ff9b5c08a68a4f8796ea0a6e2d4c3
        //Assets/Res/Model/Mat/100.mat
        /// <summary>
        ...
        public PackageBundle GetMainPackageBundle(string assetPath)
        {
            if (AssetDic.TryGetValue(assetPath, out PackageAsset packageAsset))
            {
                ...
                {
                    PackageBundle packageBundle = BundleList[bundleID];
