...
namespace YooAsset
{
    internal class HostPlayModeImpl : IPlayMode, IBundleQuery
    {
        ...
        {
            HostPlayModeInitializationOperation operation = new HostPlayModeInitializationOperation(this, initParameters);
        ...
        {
                                                                                                                   //    true         60
            RequestPackageVersionImplOperation operation = new RequestPackageVersionImplOperation(CacheFileSystem, appendTimeTicks, timeout);
        ...
        {
            UpdatePackageManifestImplOperation operation = new UpdatePackageManifestImplOperation(this, CacheFileSystem, packageVersion, timeout);
        ...
        ResourceDownloaderOperation IPlayMode.CreateResourceDownloaderByAll(int downloadingMaxNumber, int failedTryAgain, int timeout)
        {
            ...
            ResourceDownloaderOperation operation = new ResourceDownloaderOperation(PackageName, downloadList, downloadingMaxNumber, failedTryAgain, timeout);
        ...
        BundleInfo IBundleQuery.GetMainBundleInfo(AssetInfo assetInfo)
        {
            ...
            PackageBundle packageBundle = ActiveManifest.GetMainPackageBundle(assetInfo.AssetPath);
