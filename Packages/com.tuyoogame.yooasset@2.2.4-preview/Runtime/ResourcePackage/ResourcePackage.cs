...
namespace YooAsset
{
    public class ResourcePackage
    {
        ...
        public InitializationOperation InitializeAsync(InitializeParameters parameters)
        {
            ...
            {
                HostPlayModeImpl hostPlayModeImpl = new HostPlayModeImpl(PackageName);
        ...
        public UnloadUnusedAssetsOperation UnloadUnusedAssetsAsync()
        {
            ...
            UnloadUnusedAssetsOperation operation = new UnloadUnusedAssetsOperation(_resourceManager);
        ...
        private SceneHandle LoadSceneInternal(AssetInfo assetInfo, bool waitForAsyncComplete, LoadSceneMode sceneMode, LocalPhysicsMode physicsMode, bool suspendLoad, uint priority)
        {
            ...
            LoadSceneParameters loadSceneParams = new LoadSceneParameters(sceneMode, physicsMode);

            SceneHandle handle = _resourceManager.LoadSceneAsync(assetInfo, loadSceneParams, suspendLoad, priority);
        ...
        private AssetHandle LoadAssetInternal(AssetInfo assetInfo, bool waitForAsyncComplete, uint priority)
        {
            ...
            AssetHandle handle = _resourceManager.LoadAssetAsync(assetInfo, priority);
