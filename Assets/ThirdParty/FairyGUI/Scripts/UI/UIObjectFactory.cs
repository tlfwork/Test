    ...
    public class UIObjectFactory
    {
        ...
        public static void SetPackageItemExtension(string url, System.Type type)
        {
            ...
            if (pi != null) 
                ...
                pi.extensionCreator = () => (GComponent)Activator.CreateInstance(type);

            packageItemExtensions[url] = () => (GComponent)Activator.CreateInstance(type);
        }
