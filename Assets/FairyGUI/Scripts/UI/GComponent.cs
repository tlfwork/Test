...
namespace FairyGUI
{
    ...
    public class GComponent : GObject
    {
        ...
        //基类啥都没做 就是设置了一些参数 并且先执行 CreateDisplayObject
        public GComponent()
        {
        ...
        //在UIPackage中 UIObjectFactory之后 调用这里
        ...
        {
            gameObjectName = packageItem.name; //BagComponent
            ...
            sourceWidth = buffer.ReadInt();         //500

            sourceHeight = buffer.ReadInt();        //500

            initWidth = sourceWidth;                //500

            initHeight = sourceHeight;              //500
            ...
            OverflowType overflow = (OverflowType)buffer.ReadByte();    //Visible
            ...
            int controllerCount = buffer.ReadShort();   //0
            ...
            int childCount = buffer.ReadShort();        //4
            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                else
                {
                    ...
                    ObjectType type = (ObjectType)buffer.ReadByte();    //Image  Text  Component  Image

                    string src = buffer.ReadS();    //cw4q2  null   tihw5   qz0c9

                    string pkgId = buffer.ReadS();  //null   null   null    null
        ...
        void BuildNativeDisplayList()
        {
            ...
            {
                case ChildrenRenderOrder.Ascent:    //升序
                    {
                        for (int i = 0; i < cnt; i++)
                        {
